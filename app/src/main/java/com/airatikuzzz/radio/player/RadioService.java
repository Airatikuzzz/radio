...
public class RadioService extends Service implements Player.EventListener, AudioManager.OnAudioFocusChangeListener, OnItemClickCallback {
    ...
    public static final String ACTION_PLAY = "com.airatikuzzz.radio.player.ACTION_PLAY";
    public static final String ACTION_PAUSE = "com.airatikuzzz.radio.player.ACTION_PAUSE";
    public static final String ACTION_STOP = "com.airatikuzzz.radio.player.ACTION_STOP";
